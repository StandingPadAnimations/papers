...
When multipled out, the following table is produced:
...
#align(center, [
  #table(
    ...
    inset: 10pt,
    align: horizon,
    $x^2$, $(b/2)x$, $-"x"sqrt(c - (b/2)^2)i$,
    $(b/2)x$, $(b/2)^2$, $-(b/2)sqrt(c - (b/2)^2)i$,
    $"x"sqrt(c - (b/2)^2)i$, $(b/2)sqrt(c - (b/2)^2)i$, $-(c - (b/2)^2)i^2$,
  )
])
...
#align(center, [
  #table(
    ...
    inset: 10pt,
    align: horizon,
    $x^2$, $(b/2)x$, $cancel(-"x"sqrt(c - (b/2)^2)i)$,
    $(b/2)x$, $(b/2)^2$, $cancel(-(b/2)sqrt(c - (b/2)^2)i)$,
    $cancel("x"sqrt(c - (b/2)^2)i)$, $cancel((b/2)sqrt(c - (b/2)^2)i)$, $-(c - (b/2)^2)i^2$,
  )
])
